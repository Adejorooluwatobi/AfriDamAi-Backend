...
const prisma_consultation_repository_1 = require("../../infrastructure/persistence/prisma/prisma-consultation.repository");
...
exports.ConsultationModule = ConsultationModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule, admin_module_1.AdminModule, notification_module_1.NotificationModule],
