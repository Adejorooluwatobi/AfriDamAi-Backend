...
const prisma_wishlist_repository_1 = require("../../infrastructure/persistence/prisma/prisma-wishlist.repository");
        ...
        providers: [wishlist_service_1.WishlistService,
            {
                ...
                useClass: prisma_wishlist_repository_1.PrismaWishlistRepository
            }
        ],
